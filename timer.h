...
//The next #define, defines which version of the timer to compile.  
//On matrix, any linux OS or OSX use POSIX.  
//If you are compiling on windows change POSIX to WINDOWS
